...
<div class="bg-white p-6 rounded shadow">
    <h2 class="text-2xl font-semibold mb-4">List Petugas</h2>
    <div class="flex justify-between items-center">
        <p>Daftar petugas yang mengelola transaksi kasir.</p>
                ...
                @foreach ($petugas as $isi)
                    <tr class="hover:bg-gray-100">
                        ...
                        <td class="px-6 py-4 border-b text-blue-500 cursor-pointer flex">
                            ...
                            <form action="{{route('petugas.destroy', $isi->id)}}" method="POST">
                                @csrf
                                @method('delete')
                                <button type="submit"
